...
import static com.maojianwei.MaoCloud.MaoCloud.Network.netty.handler.MaoProtocolDuplexHandler.MaoProtocolState.END;
import static com.maojianwei.MaoCloud.MaoCloud.Network.netty.handler.MaoProtocolDuplexHandler.MaoProtocolState.ENDING;
import static com.maojianwei.MaoCloud.MaoCloud.Network.netty.handler.MaoProtocolDuplexHandler.MaoProtocolState.WAIT_HELLO;
    ...
    enum MaoProtocolState {
        ...
        WAIT_HELLO{
            ...
            void processHelloMessage(ChannelHandlerContext ctx, MPHello mpHello){
                ...
                h.maoProtocolNode = h.controller.createMaoProtocolNode(ctx.channel());
